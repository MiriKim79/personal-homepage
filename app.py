...
about = {
    "paragraphs": [
        " 길을 걷다가 보이는 건물. 식물의 생김새. 주변을 둘러보는 것을 좋아해요. "
        "그냥 지나치기보다 '저건 왜 저럴까' 한 번 더 생각하는 편이에요.",
        " 사람들의 행동이나 말투에서 각자의 특징을 파악해 보는 걸 좋아해요. "
        "사람들과 장난치며 이야기하며 즐거움을 찾아요.",
        " 새로운 경험을 하는 것에 거부감이 없는 편이에요. "
        "언젠가 어떻게든 도움이 된다고 생각해요. "
        "그리고 이왕 시작한 일은 끝까지 최선을 다 하려고 노력해요."
    ],
    "motto": "후회하지 않도록, 할 수 있을 때 하자",
...
life_events = [
    ...
    },
    {
        ...
        "year": "2023",
        "title": "사람과 성장",
        "description": "방송부와 전교 부회장 활동을 병행하는 동시에, 우등생 친구들을 따라다니며 공부도 열심히 했어요. 처음으로 친구와 갈등과 화해를 겪으며 성격이 T로 변하는 계기가 되기도 했지만..",
    ...
    },
    {
        ...
        "year": "2026",
        "title": "현재",
        "description": "전공 공부와 함께 다양한 프로젝트와 대외활동 등에 도전하고 있어요.",
...
university = [
    {
        ...
        "cover_alt": "학생회 활동 사진",
        "memory": "기획차장으로서 여러 행사에 참여하며 다양한 사람을 만나볼 수 있어요",
